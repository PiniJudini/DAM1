...
public class Main {
	...
	// Es como si estuvieses pasando un ratón encima de la cadena, tu lees el nombre
	// y te deja al final de ese mismo nombre.
	// Si intentas poner un asterisco te lo pondrá al final y no al principio como
	// queremos. Por ende, lo que haremos es volver
	// a poner el cursor en la posicion inicial y lo cambiaremos
